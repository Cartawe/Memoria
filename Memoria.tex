...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/estado del arte/arch_transformer.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{images/estado del arte/vlm_ejem.png}
...
Los modelos seleccionados representan distintas aproximaciones al análisis documental mediante inteligencia artificial. Para facilitar su comparación, se agrupan en tres familias: modelos visión-lenguaje de propósito general, modelos especializados en OCR y análisis documental, y modelos ultracompactos orientados a la conversión estructurada. Esta clasificación permite relacionar la arquitectura de cada modelo con su nivel de especialización, tamaño y capacidad para procesar documentos multilingües.
